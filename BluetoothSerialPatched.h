...
#ifndef _BLUETOOTH_SERIAL_PATCHED_H_
#define _BLUETOOTH_SERIAL_PATCHED_H_
...
class BluetoothSerialPatched: public Stream
{
    public:

        BluetoothSerialPatched(void);
        ~BluetoothSerialPatched(void);
        ...
        void disableSSP();
	    bool setPin(const char*, uint8_t);
